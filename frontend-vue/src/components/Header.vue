						...
						<li class="menu-item">
							...
							<ul class="sub-menu">
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('중등', '전체')">전체 <span class="study-count">({{ regionCounts['중등']?.['전체'] || 0 }})</span></li>
											<li @click="goToStudyList('중등', '1학년')">1학년 <span class="study-count">({{ regionCounts['중등']?.['1학년'] || 0 }})</span></li>
											<li @click="goToStudyList('중등', '2학년')">2학년 <span class="study-count">({{ regionCounts['중등']?.['2학년'] || 0 }})</span></li>
											<li @click="goToStudyList('중등', '3학년')">3학년 <span class="study-count">({{ regionCounts['중등']?.['3학년'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('고등', '전체')">전체 <span class="study-count">({{ regionCounts['고등']?.['전체'] || 0 }})</span></li>
											<li @click="goToStudyList('고등', '1학년')">1학년 <span class="study-count">({{ regionCounts['고등']?.['1학년'] || 0 }})</span></li>
											<li @click="goToStudyList('고등', '2학년')">2학년 <span class="study-count">({{ regionCounts['고등']?.['2학년'] || 0 }})</span></li>
											<li @click="goToStudyList('고등', '3학년')">3학년 <span class="study-count">({{ regionCounts['고등']?.['3학년'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('대학/청년', '대학생')">대학생 <span class="study-count">({{ regionCounts['대학/청년']?.['대학생'] || 0 }})</span></li>
											<li @click="goToStudyList('대학/청년', '청년')">청년 <span class="study-count">({{ regionCounts['대학/청년']?.['청년'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('취업준비/수험', '취업준비생')">취업준비생 <span class="study-count">({{ regionCounts['취업준비/수험']?.['취업준비생'] || 0 }})</span></li>
											<li @click="goToStudyList('취업준비/수험', '수험생')">수험생 <span class="study-count">({{ regionCounts['취업준비/수험']?.['수험생'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('경력/이직', '경력')">경력 <span class="study-count">({{ regionCounts['경력/이직']?.['경력'] || 0 }})</span></li>
											<li @click="goToStudyList('경력/이직', '이직')">이직 <span class="study-count">({{ regionCounts['경력/이직']?.['이직'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('취미/자기계발', '취미')">취미 <span class="study-count">({{ regionCounts['취미/자기계발']?.['취미'] || 0 }})</span></li>
											<li @click="goToStudyList('취미/자기계발', '자기계발')">자기계발 <span class="study-count">({{ regionCounts['취미/자기계발']?.['자기계발'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
							</ul>
						...
						<li class="menu-item">
							...
							<ul class="sub-menu">
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('전공', '전체')">전체 <span class="study-count">({{ regionCounts['전공']?.['전체'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '인문계열')">인문계열 <span class="study-count">({{ regionCounts['전공']?.['인문계열'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '사회계열')">사회계열 <span class="study-count">({{ regionCounts['전공']?.['사회계열'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '자연계열')">자연계열 <span class="study-count">({{ regionCounts['전공']?.['자연계열'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '공학계열')">공학계열 <span class="study-count">({{ regionCounts['전공']?.['공학계열'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '예체능계열')">예체능계열 <span class="study-count">({{ regionCounts['전공']?.['예체능계열'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('전공', '전체')">전체 <span class="study-count">({{ regionCounts['전공']?.['전체'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '국어국문학')">국어국문학 <span class="study-count">({{ regionCounts['전공']?.['국어국문학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '영어영문학')">영어영문학 <span class="study-count">({{ regionCounts['전공']?.['영어영문학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '철학')">철학 <span class="study-count">({{ regionCounts['전공']?.['철학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '사학')">사학 <span class="study-count">({{ regionCounts['전공']?.['사학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '기타 인문계열')">기타 인문계열 <span class="study-count">({{ regionCounts['전공']?.['기타 인문계열'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('전공', '경영학')">경영학 <span class="study-count">({{ regionCounts['전공']?.['경영학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '경제학')">경제학 <span class="study-count">({{ regionCounts['전공']?.['경제학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '법학')">법학 <span class="study-count">({{ regionCounts['전공']?.['법학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '행정학')">행정학 <span class="study-count">({{ regionCounts['전공']?.['행정학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '교육학')">교육학 <span class="study-count">({{ regionCounts['전공']?.['교육학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '기타 사회계열')">기타 사회계열 <span class="study-count">({{ regionCounts['전공']?.['기타 사회계열'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('전공', '수학')">수학 <span class="study-count">({{ regionCounts['전공']?.['수학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '물리학')">물리학 <span class="study-count">({{ regionCounts['전공']?.['물리학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '화학')">화학 <span class="study-count">({{ regionCounts['전공']?.['화학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '생물학')">생물학 <span class="study-count">({{ regionCounts['전공']?.['생물학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '지구과학')">지구과학 <span class="study-count">({{ regionCounts['전공']?.['지구과학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '기타 자연계열')">기타 자연계열 <span class="study-count">({{ regionCounts['전공']?.['기타 자연계열'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('전공', '컴퓨터공학')">컴퓨터공학 <span class="study-count">({{ regionCounts['전공']?.['컴퓨터공학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '전기전자공학')">전기전자공학 <span class="study-count">({{ regionCounts['전공']?.['전기전자공학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '기계공학')">기계공학 <span class="study-count">({{ regionCounts['전공']?.['기계공학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '화학공학')">화학공학 <span class="study-count">({{ regionCounts['전공']?.['화학공학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '건축공학')">건축공학 <span class="study-count">({{ regionCounts['전공']?.['건축공학'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '기타 공학계열')">기타 공학계열 <span class="study-count">({{ regionCounts['전공']?.['기타 공학계열'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
								<li class="sub-menu-item category">
									...
									<div class="sub-sub-menu">
										<ul class="sub-sub-menu-column">
											<li @click="goToStudyList('전공', '음악')">음악 <span class="study-count">({{ regionCounts['전공']?.['음악'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '미술')">미술 <span class="study-count">({{ regionCounts['전공']?.['미술'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '체육')">체육 <span class="study-count">({{ regionCounts['전공']?.['체육'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '디자인')">디자인 <span class="study-count">({{ regionCounts['전공']?.['디자인'] || 0 }})</span></li>
											<li @click="goToStudyList('전공', '기타 예체능계열')">기타 예체능계열 <span class="study-count">({{ regionCounts['전공']?.['기타 예체능계열'] || 0 }})</span></li>
										</ul>
									</div>
								</li>
							</ul>
