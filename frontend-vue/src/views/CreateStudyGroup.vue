        ...
        <form @submit.prevent="handleSubmit" class="study-form">
            <div class="form-group">
                ...
                <input
                    type="text"
                    id="name"
                    v-model="studyGroup.name"
                    required
                    placeholder="스터디 그룹 이름을 입력하세요"
                />
            </div>
            ...
            <div class="categories">
                <div class="form-group">
                    ...
                    <select
                        id="mainCategory"
                        v-model="studyGroup.mainCategory"
                        required
                ...
                <div class="form-group">
                    ...
                    <select
                        id="subCategory"
                        v-model="studyGroup.subCategory"
                        required
                ...
                <div class="form-group">
                    ...
                    <select
                        id="detailCategory"
                        v-model="studyGroup.detailCategory"
                        required
    ...
    '지역별': {
        ...
        '대구': ['군위군', '남구', '달서구', '달성군', '동구', '북구', '서구',
				...
				'충남': ['공주시', '금산군', '논산시', '당진시', '보령시', '부여군', '서산시',
					...
					'태안군', '홍성군', '계룡시'],
				'츙뷱': ['괴산군', '단양군', '보은군', '영동군', '옥천군', '음성군', '제천시',
